...
import { 
  ...
  Landmark, Briefcase, ShieldCheck, Loader2 
} from "lucide-react";
    ...
    <div className="content-wrapper">
      ...
      {loading ? (
        <div className="status-msg">
          <Loader2 className="spin" /> Loading your applications...
        </div>
      ) : (
            ...
            filteredApps.map(app => (
              ...
              >
                <div className="card-left-content">
                  ...
                  <div className="service-text-details">
                    ...
                    <div className="service-meta-container">
                      ...
                      <div
                        className={`status-tag-inline ${app.applicationStatus?.toLowerCase()}`}
                      >
                ...
                <div
                  ...
                  onClick={() =>
                    navigate(`/citizen/application-details/${app.applicationId}`)
                  }
                >
                  <Eye size={20} />
