...
function RegisterPage() {
 ...
 const validate = () => {
    ...
    // Role validation
    if (!formData.roleID) {
      tempErrors.roleID = "Please select a role";
    }

    // Department validation (Only for Officers)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatusMessage(err.response?.data || "Registration failed.");
    }
  };
      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit} className="auth-form" noValidate>
          ...
          <div className="form-group mb-4">
            <label className="d-flex align-items-center gap-2 mb-1">
              <Briefcase size={16} /> Department <span className="text-danger">*</span>
            </label>
            <select 
        ...
        {statusMessage && <div className="alert alert-info mt-3 py-2 small text-center">{statusMessage}</div>}
